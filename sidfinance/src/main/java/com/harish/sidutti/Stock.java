...
import com.harish.sidutti.histquotes.HistQuotesRequest;
import com.harish.sidutti.histquotes.HistoricalQuote;
import com.harish.sidutti.histquotes.Interval;
import com.harish.sidutti.histquotes2.HistDividendsRequest;
import com.harish.sidutti.histquotes2.HistQuotes2Request;
import com.harish.sidutti.histquotes2.HistSplitsRequest;
import com.harish.sidutti.histquotes2.HistoricalDividend;
import com.harish.sidutti.histquotes2.HistoricalSplit;
import com.harish.sidutti.quotes.csv.StockQuotesData;
import com.harish.sidutti.quotes.csv.StockQuotesRequest;
import com.harish.sidutti.quotes.query1v7.StockQuotesQuery1V7Request;
...
public class Stock {
     ...
     */
    public void getQuote(boolean refresh) throws IOException {
        if (refresh) {
            this.update();
        }
    }
     ...
     * @throws java.io.IOException when there's a connection problem
     */
    public void getStats(boolean refresh) throws IOException {
        if (refresh) {
            this.update();
        }
    }
     ...
     * @throws java.io.IOException when there's a connection problem
     */
    public void getDividend(boolean refresh) throws IOException {
        if (refresh) {
            this.update();
        }
    }
