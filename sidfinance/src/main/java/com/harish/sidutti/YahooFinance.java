...
import com.harish.sidutti.quotes.csv.FxQuotesRequest;
...
import com.harish.sidutti.quotes.fx.FxSymbols;
import com.harish.sidutti.quotes.query1v7.FxQuotesQuery1V7Request;
...
public class YahooFinance {
        ...
        private static Map<String, Stock> getQuotes(String query, Calendar from, Calendar to, Interval interval) throws IOException {
                ...
                YahooFinance.fetchHistoricalQuotes(stocks, from, to, interval);
                return stocks;
        }
